...
class Agent:
    ...
    def _draft(self) -> Node:
        ...
        user_prompt = [
            ...
            f"The task is to Predict the probability of getting sick on the third day ",
            f'All the provided input data is stored in "sample.zip" directory.',
...
# =================================== do not modify text extraction part ===================================
...
print(y_train.head())
print(y_train.unique()[:20])   # 看前20種不同的值
print(y_train.dtype)
...
# use Regressor isntead of Classifier
...
submission_df = pd.DataFrame({'id': test_df['id'], 'tested_positive_day3': y_pred})

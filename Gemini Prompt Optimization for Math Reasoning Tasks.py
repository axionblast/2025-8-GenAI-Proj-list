...
!pip install tqdm jinja2 Gradio
...
# STEP 5: Sample questions for evaluating prompt
...
You are a math professor. Solve the following math question independently from scratch every time. Follow the steps:

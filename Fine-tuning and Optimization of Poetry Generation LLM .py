...
for tang in test_tang_list:
  demo_before_finetune.append(f'model input :\n"The following is the first line of a Tang poem. Please use your knowledge to determine and complete the entire poem.
  {tang}\n\nmodel output:\n'+evaluate('"The following is the first line of a Tang poem. Please use your knowledge to determine and complete the entire poem.', generation_config, max_len, tang, verbose = False))
